...
public class PrepareDecodeHandler  extends Handler {
    private static final String TAG = PrepareDecodeHandler.class.getSimpleName();

    private final ScanPrepareActivity activity;
    private final MultiFormatReader multiFormatReader;

    PrepareDecodeHandler(ScanPrepareActivity activity,
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            bundle.putParcelable(PrepareDecodeThread.BARCODE_BITMAP,
